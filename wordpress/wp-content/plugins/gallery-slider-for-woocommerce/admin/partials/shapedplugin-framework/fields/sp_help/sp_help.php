...
if ( ! class_exists( 'WCGS_Field_sp_help' ) ) {
	/**
	 *
	 * Field: help
	 *
	 ...
	 * @version 1.0.0
	 */
	class WCGS_Field_sp_help extends WCGS_Fields {
		...
		<div class="wrap about-wrap sp-wcgs-help">
			<h1><?php esc_html_e( 'Welcome to WooCommerce Gallery Slider Pro!', 'woo-gallery-slider-pro' ); ?></h1>
			<p class="about-text">
			<?php
			esc_html_e( 'Get introduced to WooCommerce Gallery Slider premium plugin by watching our "Getting Started" video tutorial series. This video will help you get started with the plugin.', 'woo-gallery-slider-pro' );
			?>
				</p>
			...
			<div class="headline-feature feature-video">
				<iframe width="560" height="315" src="https://www.youtube.com/embed/5iQdH9TkUmc?list=PLoUb-7uG-5jOfPvxrcSUrjdjclEp9KLRj" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
			</div>
				</div>
			...
			<div class="feature-section three-col">
				...
				<div class="col">
					<div class="sp-wcgs-feature">
						...
						<p>Check out our documentation page and more information about what you can do with WooCommerce Gallery Slider Pro.</p>
						<a href="https://docs.shapedplugin.com/docs/gallery-slider-for-woocommerce-pro/overview/" target="_blank" class="wcgs-help-button">Documentation</a>
					</div>
				</div>
				<div class="col">
					<div class="sp-wcgs-feature">
						...
						<a href="https://shapedplugin.com/plugin/woocommerce-gallery-slider-pro/#reviews" target="_blank" class="wcgs-help-button">Review Now</a>
					</div>
				</div>
			</div>
