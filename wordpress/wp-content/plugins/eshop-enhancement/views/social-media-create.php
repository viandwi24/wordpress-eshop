...
<div class="wrap">
    ...
    <form method="POST" class="form-wrap validate">
        ...
        <div class="form-field form-required term-name-wrap">
            <label for="social_media_logo">Social Media Logo</label>
            <input name="social_media_logo" id="social_media_logo" type="text" value="<?= @$data->social_media_logo ?>" size="40" aria-required="true" placeholder="Url Icon or Font Awesome Class..." require>
        </div>
